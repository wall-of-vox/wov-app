                ...
                <View className="w-full max-w-md self-center">
                    <View className="items-center mb-4">
                        <View className="w-12 h-12 bg-blue-600 rounded-xl items-center justify-center">
                            <Text className="text-white font-bold">WOV</Text>
                        </View>
                        <Text className="text-xl font-medium mt-3">Create Wov</Text>
                    </View>
                    ...
                    <View className="gap-6">
                        ...
                        <View className="relative">
                            ...
                            <View className="absolute inset-0 justify-center items-center">
                                <Text className="text-xs uppercase bg-white px-2 text-gray-500">OR</Text>
                            </View>
                        </View>
